<%-- 
    Document   : registrabaj2
    Created on : 30 oct 2023, 15:37:04
    Author     : brigi
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/registrabaj2.css">
...
<section class="parraf">
    <p>Continúe registrando los datos</p>
</section>
<br><br>
...
<section class="formu">
    ...
    <form action="">
        ...
        <input type="text" placeholder="Fondo de pensiones">
...
<section class="botones">
    <div class="boton">
        <a href="registrabaj3.jsp">Continuar</a><br><br>
    </div>
</section>
<br><br>
