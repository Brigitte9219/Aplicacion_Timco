<%-- 
    Document   : asignar
    Created on : 30 oct 2023, 18:30:36
    Author     : brigi
--%>
...
<section class="asignar">
    <p><h1><b>ASIGNAR PRODUCTOS</b></h1></p>
</section>
<br>

<!--Seccion 2-->
<section class="parrafo">
    <p>Este módulo le permitirá realizar la</p>
    <p>asignación de productos para que el</p>
    <p>personal pueda desarrollar su</p>
    <p>actividad de forma segura</p>
</section>
<br><br><br>
...
<section class="botones">
    <div class="boton">
        <a href="asignar1.jsp">Asignar</a><br><br>
    </div>
</section>
<br><br>
