<%-- 
    Document   : registrabaj3
    Created on : 30 oct 2023, 15:42:20
    Author     : brigi
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/registrabaj3.css">
...
<section class="formu">
    <article class="izqui">
    <form action="">
        <input type="text" placeholder="Camisa">
        <input type="text" placeholder="Chaqueta">
    </form>
    </article>
    <aside class="der">
    <form action="">
        <input type="text" placeholder="Pantalón">
        <input type="number" placeholder="Calzado">
    </form>
    </aside>
</section>
<br>
...
<section class="formu">
    ...
    <form action="">
        ...
        <input type="tel" placeholder="Teléfono móvil">
    </form>
    </article>
    <aside class="der">
    <form action="">
...
<section class="botones">
    <div class="boton">
        <a href="registrabaj4.jsp">Guardar</a><br><br>
    </div>
</section>
<br><br>
