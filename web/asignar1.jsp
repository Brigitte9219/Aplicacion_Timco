<%-- 
    Document   : asignar1
    Created on : 30 oct 2023, 18:37:39
    Author     : brigi
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/asignar1.css">
...
<!--CONTENIDO-->
<!--Sección 1-->
<section class="asignar">
    <p><h1><b>Asignar</b></h1></p>
</section>
<br>

<!--Sección 2-->
<section class="parraf">
    <p>Realice la asignación de un producto de acuerdo con la solicitud previa</p>
</section>
<br><br>
...
<section class="formu">
    <article class="izqui">
        <form action="">
            <input type="date" placeholder="Fecha de asignación">
...
<section class="botones">
    <div class="boton">
        <a href="asignar2.jsp">Enviar</a><br><br>
    </div>
</section>
<br><br>
