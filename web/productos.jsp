<%-- 
    Document   : productos
    Created on : 30 oct 2023, 17:01:19
    Author     : brigi
--%>
...
<html>
    ...
    <title>Administrar información de los productos</title>
...
<nav class="navegacion">
    <div class="rectangulo">
        ...
        <a href="2Contacto.jspl">Contacto</a>
...
<section class="productos">
    <p><h1><b>ADMINISTRAR INFORMACIÓN</b></h1></p>
    <p><h1><b>DE LOS PRODUCTOS</b></h1></p>
</section>
<br>

<!--Seccion 2-->
<section class="parrafo">
    <p>Este módulo le permitirá administrar</p>
    <p>información de los productos de la</p>
    <p>compañía.</p>
</section>
<br><br>
...
<section class="botones">
    <div class="boton">
        <a href="regisproduc1.jsp">Registrar</a><br><br><br>
        <a href="1Modulos.jsp">Base de datos productos</a><br><br>
    </div>
</section>
<br><br>
