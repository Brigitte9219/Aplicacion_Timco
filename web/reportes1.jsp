<%-- 
    Document   : reportes1
    Created on : 30 oct 2023, 19:18:10
    Author     : brigi
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/reportes1.css">
    <title>Gestionar reportes o informes</title>
...
<section class="consulta">
    <p><h1><b>Consulta</b></h1></p>
</section>
<br>

<!--Seccion 2-->
<section class="parraf">
    <p>A continuación, ingrese los datos para realizar la consulta</p>
</section>
<br><br>
...
<section class="sec">
    <article class="izqui">
        <p>Nombre del trabajador</p><br>
        <p>No de identificación</p><br>
        <p>Nombre del producto</p><br>
        <p>Fecha de inicio</p><br>
        <p>Fecha final</p><br>
        <p>Proyecto</p><br>
    </article>
    <aside class="der">
...
<section class="botones">
    <div class="boton">
        <a href="reportes2.jsp">Buscar</a><br><br>
    </div>
</section>
<br><br>
