<%-- 
    Document   : reportes
    Created on : 30 oct 2023, 19:09:37
    Author     : brigi
--%>
...
<section class="reporte">
    <p><h1><b>GESTIONAR REPORTES O</b></h1></p>
    <p><h1><b>INFORMES</b></h1></p>
</section>
<br>

<!--Seccion 2-->
<section class="parrafo">
    <p>Este módulo sirve para realizar</p>
    <p>consultas y descargar la información</p>
    <p>de acuerdo con su preferencia</p>
</section>
<br><br>
...
<section class="botones">
    <div class="boton">
        <a href="reportes1.jsp">Consultar</a><br><br>
    </div>
</section>
<br><br>
